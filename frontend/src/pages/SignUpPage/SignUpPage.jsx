  ...
  return (
    <main className="sign-up-page">
      ...
      <form className="sign-up-page__form" onSubmit={handleSubmit}>
        ...
        <TextInput id="name" placeholder="Name" hadAttempt={hadAttempt} onInput={onInput}/>
        <TextInput id="role" placeholder="Role" hadAttempt={hadAttempt} onInput={onInput}/>
        <TextInput id="major" placeholder="Major" hadAttempt={hadAttempt} onInput={onInput}/>
        <TextInput id="minor" placeholder="Minor" hadAttempt={hadAttempt} onInput={onInput}/>
        <TextInput id="birthday" placeholder="Birthday" hadAttempt={hadAttempt} onInput={onInput}/>
        <TextInput id="home" placeholder="Home" hadAttempt={hadAttempt} onInput={onInput}/>
        <TextInput id="quote" placeholder="Quote" hadAttempt={hadAttempt} onInput={onInput}/>
        <TextInput id="favoritething1" placeholder="Favorite Thing 1" hadAttempt={hadAttempt} onInput={onInput}/>
        <TextInput id="favoritething2" placeholder="Favorite Thing 2" hadAttempt={hadAttempt} onInput={onInput}/>
        <TextInput id="favoritething3" placeholder="Favorite Thing 3" hadAttempt={hadAttempt} onInput={onInput}/>
        <TextInput id="favoritedartmouthtradition" placeholder="Favorite Dartmouth Tradition" hadAttempt={hadAttempt} onInput={onInput}/>
        <TextInput id="funfact" placeholder="Fun Fact" hadAttempt={hadAttempt} onInput={onInput}/>
        <TextInput id="image" placeholder="Image" hadAttempt={hadAttempt} onInput={onInput}/>
